...
$query = "SELECT " + $column['id'] + "," + $column['newvalue'] + "," + $column['attribute'] + "," + $column['userDN'] + "," + $column['emailtext'] + "," + $column['emailrecipient'] + "," + $column['emailsubject'] + " FROM $SQLTable WHERE [AD_Attribut] not in ('Group','RemoveGroup') and verarbeitet IS NULL"
